...
url = 'https://raw.githubusercontent.com/AguaClara/ram_pump/master/Spring%202019/3-23-2019_test1.xls'
pp.notes(url)
start = 3718 #should be more than 'start'
end = 30357 #should be less than 'stop'
...
plt.legend()
#plt.show()
plt.savefig('pressure_trace_initialpressure0323_1.jpg', dpi=200, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,frameon=None, metadata=None)
...
url = 'https://raw.githubusercontent.com/AguaClara/ram_pump/master/Spring%202019/3-23-2019_test0.xls'
...
start = 2966 #should be more than 'start'
...
diam = 1*u.inch
height_water = 18.2 * u.cm #initial height of water in air chamber
