...
url = 'https://raw.githubusercontent.com/AguaClara/ram_pump/master/Spring%202019/3-23-2019_test3.xls'
pp.notes(url)
start = 12751 #should be more than 'start'
end = 32244 #should be less than 'stop'
...
plt.legend()
#plt.show()
plt.savefig('pressure_trace_initialpressure0323_3.jpg', dpi=200, facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format=None,transparent=False, bbox_inches=None, pad_inches=0.1,frameon=None, metadata=None)
...
diam = 1*u.inch
height_water = (26.5*u.inch)- (6.3*u.cm) #initial height of water in air chamber
...
print('The volume of water pumped per 10 cycles is ' + str(deltaV))
